...
3. Kiểm tra file env trước khi chạy:
...
Compose sẽ chạy service one-shot `migrations`; các service dùng DB chỉ được
khởi động khi migration hoàn tất thành công.
...
6. Đi qua checklist trước khi mở traffic thật:
