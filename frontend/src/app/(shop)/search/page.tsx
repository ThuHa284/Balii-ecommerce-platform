        ...
        <div className="text-center mb-10">
          ...
          <form className="max-w-lg mx-auto relative" action="/search" method="get">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-4 rounded-2xl glass-card text-sm focus:outline-none focus:ring-2 focus:ring-violet-300"
            />
          </form>
        </div>
        ...
        {query && (
          <div className="mb-8">
            <p className="text-muted-foreground">
              ...
              kết quả cho <span className="text-primary">&ldquo;{query}&rdquo;</span>
            </p>
          </div>
        )}

        {visibleResults.length > 0 ? (
          <ProductGrid products={visibleResults} columns={4} />
        ) : query ? (
