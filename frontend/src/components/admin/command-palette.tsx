...
const NAV_OPTIONS: NavOption[] = [
  ...
  },
  {
    ...
    category: 'Nội dung',
    icon: Library,
    keywords: 'bo suu tap collection collections season banner',
  },
  {
    ...
    category: 'Khuyến mãi',
    icon: Megaphone,
    keywords: 'chien dich campaign sale promotion marketing',
  },
  {
  ...
  },
  {
    ...
    category: 'Hệ thống',
    icon: Network,
    keywords: 'kafka topic event producer consumer worker outbox message',
